...
{
       0,    80,    80,    81,    84,    87,    90,    95,    96,    99,
     102,   106,   109,   112,   117,   120,   124,   131,   143,   143,
     147,   147,   149
};
#endif
...
static const char *const yytname[] =
{
  ...
  "t_number", "t_dot", "t_token_char", "t_lws", "t_colon", "t_separators",
  "t_sp", "t_ws", "t_ctl", "$accept", "allowed_char_for_token", "token",
  "allowed_char_for_text", "ows", "text", "request_line",
  "request_header_t", "request_header", "request_headers", "request", YY_NULLPTR
};
#endif
...
{
      39,   -24,   -24,   -24,   -24,    33,    39,     9,    26,   -24,
      16,   -24,    39,    -1,   -24,   -24,   -24,   -24,   -24,   -24,
       4,   -24,   -24,    -6,   -24,   -24,    26,    26,    13,     2,
     -24,    26,   -24,     7,   -24
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      11,    18,    21,     0,     1,    10,     9,     8,     7,    14,
      11,    12,    13,     0,    19,    22,     0,     0,    11,    11,
      15,     0,    16,    11,    17
};
...
{
      23,     4,    25,    29,    28,    32,     9,     4,    33,    14,
      34,     9,     5,     4,    21,    22,    26,    22,    31,    21,
      22,     1,    30,     2,     3,    21,    22,    24,    21,    22,
      15,     1,     0,     2,     3,     0,    16,    17,     1,     0,
       2,     3,     0,     0,     1,     8,     2,     3
};

static const yytype_int8 yycheck[] =
{
      10,     0,     3,    26,    10,     3,     5,     6,    31,     0,
       3,    10,     0,    12,    12,    13,    12,    13,    28,    12,
      13,     5,    27,     7,     8,    12,    13,    12,    12,    13,
       4,     5,    -1,     7,     8,    -1,    10,    11,     5,    -1,
       7,     8,    -1,    -1,     5,    12,     7,     8
};
...
{
       0,     5,     7,     8,    16,    17,    21,    25,    12,    16,
      17,    22,    23,    24,     0,     4,    10,    11,    16,    18,
      20,    12,    13,    19,    22,     3,    12,    19,    10,    20,
      18,    19,     3,    20,     3
};
...
#line 131 "parser.y" /* yacc.c:1646  */
    ...
    strcpy(cur_request_header->header_name, (yyvsp[-5].str));
    strcpy(cur_request_header->header_value, (yyvsp[-1].str));
